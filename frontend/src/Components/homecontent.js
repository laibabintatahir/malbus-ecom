    ...
    <div>
      <div>
        <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              <img src="../images/d1.png" className="d-block w-100" alt="..." />
            </div>
          </div>
      ...
      <div>
        <div className="abaya-container">
          {abaya.map((abaya, index) => (
            <div className="abaya-card" key={index}>
              <Link to="/details" state={{ from: abaya }}>
                <img src={abaya.image} alt={abaya.name} className="abaya-img" />
              </Link>
              <div className="sm-cart">
                <p style={{ marginTop: '1%', marginBottom: '1%' }}>{abaya.name}</p>
                <h6>Rs. {abaya.price} PKR</h6>
                <button className="b1">
                  <img src="../images/shopping-bag.png" alt="l" style={{ width: '21px', height: '21px', marginRight: '3%', marginBottom: '1%' }} />
                  ADD TO CART
                </button>
              </div>
            </div>
      ...
      <h3 className="new-arr">NEW ARRIVAL HIJABS & ACCESSORIES</h3>
      <div>
        <div className="abaya-container">
          {hijab.map((hijab, index) => (
            <div className="abaya-card" key={index}>
              <Link to="/details" state={{ from: hijab }}>
                <img src={hijab.image} alt={hijab.name} className="abaya-img" />
              </Link>
              <div className="sm-cart">
