...
//       <table className="blueTable" style={{ width: '90%', borderCollapse: 'collapse', padding: '2%', marginLeft: '5%' }}>
//         <thead>
//           <tr>
...
function Customers() {
  ...
  return (
    <div>
      ...
      <h2 style={{ textAlign: 'center', marginTop: '3%', marginBottom: '2%' }}>Customers' Data</h2>
      <table style={{ width: '90%', borderCollapse: 'collapse', padding: '2%', marginLeft: '5%', backgroundColor: '#f3dec3', color: 'black' }}>
        <thead>
          <tr>
            <th style={tableHeaderStyle}>First Name</th>
            <th style={tableHeaderStyle}>Last Name</th>
